<template>
    <aside id="sidebar" :class="[
        'fixed top-0 left-0 z-[9998] flex flex-col flex-shrink-0 w-64 h-full pt-16 font-normal duration-75 transition-width',
        ...
        <div class="relative flex flex-col flex-1 min-h-0 pt-0 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <a :href="dataPeserta" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                            ...
                            <span class="ml-3" sidebar-toggle-item>Data Peserta</span>
                        </a>
                    </li>
                    <li>
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Data Code</span>
                        <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                        </button>
                        <ul id="dropdown-crud" class="hidden py-2 space-y-2">
                            <li>
                                <a :href="dataPseudoCode" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Pseudo Code</a>
                            </li>
                            <li>
                                <a :href="dataSourceCode" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Source Code</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a :href="dataLevel" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                            ...
                            <span class="ml-3" sidebar-toggle-item>Data Level</span>
                        </a>
                    </li>
                    <li>
                        <a :href="dataNilai" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                            ...
                            <span class="ml-3" sidebar-toggle-item>Data Nilai</span>
                        </a>
                    </li>
                </ul>
            </div>
