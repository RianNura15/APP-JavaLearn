<template>
    <aside id="sidebar" :class="[
        'fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 w-64 h-full pt-16 font-normal duration-75 transition-width',
            ...
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                ...
                <li>
                    ...
                    <ul id="dropdown-crud" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Users</a>
                        </li>
                    </ul>
                </li>
                <li>
