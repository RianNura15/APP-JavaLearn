                        ...
                        <div id="fullWidthTabContent" class="border-t border-gray-200 dark:border-gray-600">
                            ...
                            <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <img class="flex-shrink-0 w-10 h-10" :src="'/Template/images/products/iphone.png'" alt="imac image">
                                    <div class="ml-3">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center min-w-0">
                                    <img class="flex-shrink-0 w-10 h-10" :src="'/Template/images/products/imac.png'" alt="imac image">
                                    <div class="ml-3">
                                        <p class="font-medium text-gray-900 truncate dark:text-white">
                                        Apple iMac 27"
                                        </p>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center min-w-0">
                                    <img class="flex-shrink-0 w-10 h-10" :src="'/Template/images/products/watch.png'" alt="watch image">
                                    <div class="ml-3">
                                        <p class="font-medium text-gray-900 truncate dark:text-white">
                                        Apple Watch SE
                                        </p>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center min-w-0">
                                    <img class="flex-shrink-0 w-10 h-10" :src="'/Template/images/products/ipad.png'" alt="ipad image">
                                    <div class="ml-3">
                                        <p class="font-medium text-gray-900 truncate dark:text-white">
                                        Apple iPad Air
                                        </p>
                            ...
                            <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="flex-shrink-0">
                                    <img class="w-8 h-8 rounded-full" :src="'/Template/images/users/neil-sims.png'" alt="Neil image">
                                    </div>
                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="flex-shrink-0">
                                    <img class="w-8 h-8 rounded-full" :src="'/Template/images/users/bonnie-green.png'" alt="Neil image">
                                    </div>
                                    <div class="flex-1 min-w-0">
                                    <p class="font-medium text-gray-900 truncate dark:text-white">
                                        Bonnie Green
                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="flex-shrink-0">
                                    <img class="w-8 h-8 rounded-full" :src="'/Template/images/users/michael-gough.png'" alt="Neil image">
                                    </div>
                                    <div class="flex-1 min-w-0">
                                    <p class="font-medium text-gray-900 truncate dark:text-white">
                                        Michael Gough
                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="flex-shrink-0">
                                    <img class="w-8 h-8 rounded-full" :src="'/Template/images/users/thomas-lean.png'" alt="Neil image">
                                    </div>
                                    <div class="flex-1 min-w-0">
                                    <p class="font-medium text-gray-900 truncate dark:text-white">
                                        Thomes Lean
                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="flex-shrink-0">
                                    <img class="w-8 h-8 rounded-full" :src="'/Template/images/users/lana-byrd.png'" alt="Neil image">
                                    </div>
                                    <div class="flex-1 min-w-0">
                                    <p class="font-medium text-gray-900 truncate dark:text-white">
                                        Lana Byrd
